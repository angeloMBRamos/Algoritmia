...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //Main que resolve o exercicio
       /* Unit meleeUnit = new Unit(new MeleeAttackStrategy(),"Geralt");
        meleeUnit.performAttack();

        Unit rangedUnit = new Unit(new RangedAttackStrategy(), "Geralt");
        rangedUnit.performAttack();

        Unit magicUnit = new Unit(new MagicAttackStrategy(),"Geralt");

...
public class Main {
    public static void main(String[] args) {
        ...
        //System.out.println("Total com desconto fixo: " + total);paymentProcessor = new PaymentProcessor(new PercentageDiscountStrategy(0.2));

        total = paymentProcessor.calculateTotal(100.0);System.out.println("Total com desconto percentual: " + total);
    }
